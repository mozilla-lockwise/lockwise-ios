        ...
        describe("SettingRouteAction") {
            describe("telemetry") {
                ...
                it("event object is equal to the setting view shown") {
                    ...
                    expect(SettingRouteAction.privacy.eventObject).to(equal(TelemetryEventObject.settingsPrivacy))
                ...
                it("returns nil as the value") {
                    ...
                    expect(SettingRouteAction.privacy.value).to(beNil())
                ...
                it("returns nil as for the extras") {
                    ...
                    expect(SettingRouteAction.privacy.extras).to(beNil())
