...
struct Constant {
    ...
    struct string {
        ...
        static let unlockPlaceholder = NSLocalizedString("unlock_placeholder", value: "Unlock Firefox Lockbox", comment: "Placeholder text when the user's email is unavailable while unlocking Lockbox")
