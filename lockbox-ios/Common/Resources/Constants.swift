...
extension Constant.string {
    ...
    static let confirmDialogMessage = NSLocalizedString("confirm_dialog_message", value: "This will delete your Firefox Account information and all saved entries from %@.", comment: "Confirm dialog message")
    ...
    static let autoLockHeader = NSLocalizedString("settings.autoLock.header", value: "Sign out of %@ after", comment: "Header displayed above auto lock settings. %@ will be replaced with the application name")
    ...
    static let settingsAutoFillSettings = NSLocalizedString("settings.autoFillSettings", value: "AutoFill Passwords Settings", comment: "Label to link to iOS AutoFill Settings. AutoFill should be localized to match the proper name for Apple’s system feature")
    ...
    static let passcodeDetailInformation = NSLocalizedString("passcode_detail_information", value: "In order to lock %@, a passcode must be set up on your device. Without a passcode, anyone who has your iPhone can access the information saved here.", comment: "Message for dialog box with passcode reminder. %@ will be replaced with the application name")
    ...
    static let sortOptionsAccessibilityID = NSLocalizedString("sorting_options", value: "Select options for sorting your list of entries (currently %@)", comment: "Accessibility identifier for the sorting options button. %@ will be replaced with the currently-set sort option")
    ...
    static let websiteCellAccessibilityLabel = NSLocalizedString("website_accessibility_instructions", value: "Web address: double tap to open in browser %@", comment: "Accessibility label and instructions for web address section of entry details. %@ will be replaced with the browser name")
    static let usernameCellAccessibilityLabel = NSLocalizedString("username_accessibility_instructions", value: "Username: double tap to copy %@", comment: "Accessibility label and instructions for username section of entry details. %@ will be replaced with the username value")
    static let passwordCellAccessibilityLabel = NSLocalizedString("password_accessibility_instructions", value: "Password: double tap to copy %@", comment: "Accessibility label and instructions for password section of entry details. %@ will be replaced with the password value")
    ...
    static let disclaimerLabel = NSLocalizedString("settings.unlinkDisclaimer", value: "This removes synced entries from %@, but will not delete your entries from Firefox.", comment: "Label on account setting explaining unlink. %@ will be replaced with the application name")
