...
extension Constant.string {
    ...
    static let confirmDialogTitle = NSLocalizedString("confirm_dialog_title", value: "Disconnect %@?", comment: "Confirm dialog title")
    ...
    static let autoLockHeader = NSLocalizedString("settings.autoLock.header", value: "Sign out of %@ after", comment: "Header displayed above auto lock settings")
    ...
    static let settingsUsageDataSubtitle = NSLocalizedString("settings.usageData.subtitle", value: "Mozilla strives to only collect what we need to provide and improve %@ for everyone. ", comment: "Setting for send usage data subtitle")
    ...
    static let passcodeDetailInformation = NSLocalizedString("passcode_detail_information", value: "In order to lock %@, a passcode must be set up on your device. Without a passcode, anyone who has your iPhone can access the information saved here.", comment: "Message for dialog box with passcode reminder")
