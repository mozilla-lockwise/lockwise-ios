...
extension Constant.string {
    ...
    static let recent = NSLocalizedString("recent", value: "Recent", comment: "Button title when logins list is sorted by most recently used entry")
    static let recentlyUsed = NSLocalizedString("recently_used", value: "Recently Used", comment: "Label for the option sheet action allowing users to sort an entry list by the most recently used logins")
