...
extension Constant.string {
    ...
    static let settingsAutoFillSettings = NSLocalizedString("settings.autoFillSettings", value: "AutoFill Password Settings", comment: "Label to link to iOS AutoFill Settings")
