...
struct Constant {
    ...
    struct string {
        ...
        static let onboardingTouchIDHeader = NSLocalizedString("onboarding.touchid.header", value: "Sign in with Touch ID", comment: "Header for screen allowing users to enable Touch ID")
        static let onboardingTouchIDSubtitle = NSLocalizedString("onboarding.touchid.message", value: "Access Firefox Lockbox with just a touch.", comment: "Subtitle for screen allowing users to enable Touch ID")
        static let onboardingTouchIDEnable = NSLocalizedString("onboarding.touchid.enable", value: "Use Touch ID", comment: "Label for the button during onboarding to Enable Touch ID")
        ...
        static let onboardingFaceIDEnable = NSLocalizedString("onboarding.faceid.enable", value: "Use Face ID", comment: "Label for the button during onboarding to Enable Face ID")
